...
const SUITS = [
  {
    ...
    reunionDomain: "다시 다가가고 싶은 적극적인 마음",
  ...
  },
  {
    ...
    reunionDomain: "다시 이어지고 싶은 그리움과 감정",
  ...
  },
  {
    ...
    reunionDomain: "재회에 대해 솔직하게 정리하는 생각",
  ...
  },
  {
    ...
    reunionDomain: "다시 안정적인 관계를 쌓아가려는 현실적인 노력",
...
const RANKS = [
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${i(s.reunionDomain)} 새롭게 피어나기 시작하는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain} 속에서 다시 다가갈지 신중하게 저울질하게 되는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${i(s.reunionDomain)} 주변 상황을 통해 다시 확인되는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${i(s.reunionDomain)} 잠시 멈춰 편안하게 정리되는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}에서 작은 엇갈림이나 오해가 생길 수 있는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${i(s.reunionDomain)} 서로의 배려 속에서 조금씩 회복되는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${eul(s.reunionDomain)} 서두르지 않고 지켜봐야 하는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${i(s.reunionDomain)} 빠르게 진전될 수 있는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${i(s.reunionDomain)} 결실을 눈앞에 두고 있는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${i(s.reunionDomain)} 하나의 결론에 도달하는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${eul(s.reunionDomain)} 조심스럽게 다시 확인해가는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${eul(s.reunionDomain)} 향해 적극적으로 움직이고 싶어지는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${eul(s.reunionDomain)} 여유롭고 성숙하게 다룰 수 있는 시기예요.`,
  ...
  },
  {
    ...
    build: (s) => ({
      ...
      reunion: `${s.reunionDomain}${eul(s.reunionDomain)} 주도적으로 다시 이끌어가고 싶어지는 시기예요.`,
...
SUITS.forEach((suit) => {
  RANKS.forEach((rank, index) => {
    ...
    reunionMeaning: \`${esc(fields.reunion)}\`,
